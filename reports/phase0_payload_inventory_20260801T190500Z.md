# Phase 0 payload inventory refresh (20260801T190500Z)
...
- Selected-run FASTQ batch audit: `TWO_SELECTED_RUN_PAIR_AUDITS_COMPLETE_BATCH_PENDING`; this is file-integrity evidence only and does not unlock Phase 0.

- Download failure evidence: SRR31402663 returncode=56 partial preserved; SRR31402664 returncode=56 partial preserved; SRR31402663 returncode=56 partial preserved. Safe resume is required.
## Gate
