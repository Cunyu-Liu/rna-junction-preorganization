...
def main() -> int:
    ...
    acceptance["note"] += " A stable SRR31402664_2 single-file integrity audit was started with immutable run provenance; its final status is pending and does not unlock Phase 0."
