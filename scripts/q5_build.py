...
# R0 FIX: remove self-overwrite. Do NOT modify tracked source at runtime.
# Save a copy of the build script to run_root evidence instead (allowed).
import shutil
evidence_build_dir = Path(Q5DIR).parent / "evidence" / "scripts"
evidence_build_dir.mkdir(parents=True, exist_ok=True)
shutil.copy2(os.path.abspath(__file__), evidence_build_dir / "q5_build.py")
